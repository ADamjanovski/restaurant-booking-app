...
const RestaurantList = () => {
  ...
  const initialCategory = new URLSearchParams(location.search).get('initialCategory');
  const item=initialCategories.findIndex(category=> category.name===initialCategory)
