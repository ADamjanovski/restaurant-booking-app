...
const BecomePartner = () => {
  ...
  return (
    <Card>
      <form onSubmit={formSubmitHandler} className="flex flex-col lg:w-8/12">
        <label className="m-2 ">Restaurant Name</label>
        <input type="text" placeholder="Restaurant Name" className=" p-2 rounded-lg"/>
        ...
        <button className="p-2 rounded-lg bg-accent w-1/2 self-center">Submit Request</button>
      </form>
    </Card>
  );
};
