...
const ContactUs = () => {
  ...
  const formSubmitHandler = async (event) => {
    ...
    const request = await useHttp({
      url: "https://restaurant-booking-backend-adamjanovski-uhj6.onrender.com/api/users/customerService",
      method: "POST",
      body: JSON.stringify({
  ...
  return (
    <div>
      <Card>
        ...
        {!ctx.isLoggedIn && <p className="text-center">You need to be logged in to send us a message.</p>}
        {!isValid.valid && (
          ...
          >
            <div className="absolute top-[15%] sm:left-[10%] left-[3%] lg:left-[25%] md:w-[600px] w-3/4 m-10 border-2 border-neutral-400 bg-secondary">
              <Alert severity="success">
                ...
                Thank you for your input!! We will get back at you as soon as
                possible.
              </Alert>
            </div>
          </Modal>
