...
const MainPage = () => {
  return (
    <div className="mt-10 text-center">
      ...
      Reserve your <span className=" bg-clip-text bg-gradient-to-r from-primary to-accent   text-transparent">place</span> at the finest establishments in town and dine with
        happiness
      </h1>
      <SearchBar />
      <Categories />
