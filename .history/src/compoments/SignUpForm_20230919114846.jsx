  ...
  return (
    <form onSubmit={formSubmitHandler}>
      ...
      <div className="flex flex-col items-center ">
        ...
        ></input>
        {usernameInputHasError && <p className="text-sm">Username is already taken</p>}
        <input
          id="firstName"
          name="firstName"
          type="text"
        ...
        ></input>{" "}
        {nameInputHasError && <p className="text-sm self-start mx-5">First Name can't be empty</p>}
        <input
          id="surname"
          name="surname"
          type="text"
        ...
        ></input>
        {surnameInputHasError && <p>Surname can't be empty</p>}
        <input
          id="email"
          name="email"
          type="text"
        ...
        ></input>
        {emailInputHasError && <p>Email needs to contain @</p>}
        <input
          id="password"
          name="password"
          type="password"
