...
const UpcomingReservations = () => {
  ...
  const request = {
    url: `https://restaurant-booking-backend-damjanovski.onrender.comhttps://restaurant-booking-backend-damjanovski.onrender.com/api/restaurants/upcomingReservations/${authCtx.user.id}`,
    method: "GET",
    headers: {
