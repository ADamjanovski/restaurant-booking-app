  ...
  return (
    ...
    >
      <div className="relative">
        <input
          className="sm:w placeholder-white text-lg peer w-full pl-5 p-2 pr-20 rounded-lg ring-neutral-500 outline-none focus:ring-primary focus:border-none ring-2 "
          type="text"
