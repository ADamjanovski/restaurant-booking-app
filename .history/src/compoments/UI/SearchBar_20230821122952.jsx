...
const SearchBar = () => {
  ...
  return (
    <form className="flex pr-0 box-border" onSubmit={submitHandler}>
      <div className="">
        <input
          className="mt-5 placeholder-white w-full pl-5 p-2 pr-20 rounded-lg border-neutral-500 outline-none focus:ring-primary-500 focus:ring-1 border-solid border-2"
          type="text"
