      ...
      <div className="flex justify-between ">
        ...
        <nav className="w-min mt-3">
         ...
         font-sans"
          ...
          {ctx.isLoggedIn && <NavLink               className="flex w-28 justify-around rounded-2xl border-neutral-500 border-solid border-2 p-2.5 sm:w-36   "
 to="account">{UserIcon} Account</NavLink>}
        </nav>
      </div>
    </header>
  );
