  ...
  return (
    <header className="md:text-center w-full p-8  mx-auto sm:px-32">
      <div className="flex justify-between ">
        ...
        {ctx.isLoggedIn && <button type="button" className="m-3 w-40 bg-accent text=black rounded-2xl  border-neutral-500 border-solid border-2 p-2.5 sm:w-36">Log Out</button>}
      </div>
    </header>
  );
};
