  ...
  return (
    <header className="md:text-center w-full p-8  mx-auto sm:px-32">
      <div className="flex justify-between ">
        ...
        {ctx.isLoggedIn && <button type="button" onClick={logoutHandler} className="ml-3 h-12 bg-accent text-black rounded-2xl  border-neutral-500 border-solid border-2 w-20  md:w-36">Log Out</button>}
