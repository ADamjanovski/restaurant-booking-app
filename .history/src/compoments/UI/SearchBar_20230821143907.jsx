    ...
    >
      <div className="relative">
        ...
        {searchInput.length > 0 && (
          <div className="border-t-0 overscroll-auto bg-background peer-focus:flex  flex-col w-full max-h-40 overflow-y-auto absolute  rounded-md  border-neutral-500 border-solid border-2 empty:border-none hidden">
            {restaurants
              .filter((restaurant) => {
