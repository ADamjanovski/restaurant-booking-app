...
const ShowcaseTables = ({ tables, date }) => {
  ...
  const reserveHandler = async () => {
    try {
      ...
      const data = await useHttp({
        url: "https://restaurant-booking-backend-adamjanovski-uhj6.onrender.com/api/restaurants/reservation",
        method: "POST",
        body: JSON.stringify({
  ...
  return (
    <div className="flex flex-col ">
      ...
      {!authCtx.isLoggedIn &&<p className="text-center">You need to be logged in to reserve a table.</p>}
      {reserved && (
        <Modal
          open={reserved}
          onClose={handleClose}
        ...
        >
          <div className="absolute top-[15%] sm:left-[10%] left-[3%] lg:left-[33%] lg:top-[30%] md:w-[600px] w-3/4 m-10 border-2 border-neutral-400 bg-secondary">
