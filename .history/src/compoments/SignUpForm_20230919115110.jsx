    ...
    <form onSubmit={formSubmitHandler}>
      ...
      <div className="flex flex-col items-center ">
        ...
        <input
          ...
          className={`${nameInputHasError mb-4 px-3 py-1 rounded-lg lg:w-8/12`}
          required
          value={nameInputValue}
          onChange={nameChangeHandler}
          onBlur={nameInputBlurHandler}
        ></input>{" "}
        {nameInputHasError && <p className="text-sm  ">First Name can't be empty</p>}
        <input
          id="surname"
          name="surname"
          type="text"
        ...
        ></input>
        {passwordInputHasError && <p lassName="text-sm mb-4 ">Password is not strong enough</p>}
        <input
          id="confirm-password"
        ...
        ></input>
        {confirmPasswordInputHasError && <p lassName="text-sm mb-4 ">Passwords don't match.</p>}
      </div>
