...
const SignUpForm = () => {
  ...
  let formIsValid =
    emailInputIsValid && nameInputIsValid && surnameInputIsValid && confirmPasswordInputIsValid && passwordInputIsValid ? true : false;
  ...
  return (
    <form onSubmit={formSubmitHandler}>
      ...
      <div className="flex flex-col items-center ">
        ...
        ></input>
        {usernameInputHasError && <p>Invalid Username</p>}
        <input
          id="firstName"
          name="firstName"
          type="text"
