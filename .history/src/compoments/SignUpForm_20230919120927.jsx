...
const SignUpForm = () => {
  ...
  const [usernameInputIsValid, setUsernameIsValid] = useState("");
  const {
  ...
  console.log(usernameInputIsValid);
  return (
    <form onSubmit={formSubmitHandler}>
      ...
      <div className="flex flex-col items-center ">
        ...
        {!usernameInputIsValid && (
          <p lassName="text-sm mb-4 ">Username is already taken</p>
        )}
        <input
          id="firstName"
          name="firstName"
        ...
        ></input>{" "}
        {nameInputHasError && (
          <p className="text-sm mb-4 ">First Name can't be empty</p>
        )}
        <input
          id="surname"
          name="surname"
        ...
        {surnameInputHasError && (
          <p lassName="text-sm mb-4 ">Surname can't be empty</p>
        )}
        <input
          id="email"
          name="email"
        ...
        ></input>
        {emailInputHasError && (
          <p lassName="text-sm mb-4 ">Email needs to contain @</p>
        )}
        <input
          id="password"
          name="password"
        ...
        {passwordInputHasError && (
          <p lassName="text-sm mb-4 ">Password is not strong enough</p>
        )}
        <input
          id="confirm-password"
        ...
        {confirmPasswordInputHasError && (
          <p lassName="text-sm mb-4 ">Passwords don't match.</p>
        )}
      </div>
