  ...
  return (
    <form>
      ...
      <div className="w-full mb-12 pb-1 pt-1 text-center">
        <button
          className="disabled:from-neutral-200 disabled:to bg-gradient-to-r from-primary to-accent lg:w-8/12 text-transparent mb-3 inline-block w-full rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white transition duration-150 ease-in-out  focus:outline-none focus:ring-0 "
