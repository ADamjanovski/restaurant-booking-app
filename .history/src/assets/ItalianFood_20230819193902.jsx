...
const ItalianFood= ()=>{
    ...
    <svg xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ns1="http://sozi.baierouge.fr" xmlns:cc="http://creativecommons.org/ns#" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:dc="http://purl.org/dc/elements/1.1/" id="svg2" xml:space="preserve" viewBox="0 0 37.289 17.673" version="1.1" inkscape:version="0.91 r13725">
      <defs id="defs6">
        <clipPath id="clipPath22">
          <path id="path24" d="m2-0.86192h16v8h-16v-8z" inkscape:connector-curvature="0"/>
        </clipPath>
        <mask id="mask26">
          <g id="g28">
            <g id="g30" clip-path="url(#clipPath22)">
              <path id="path32" style="fill:#000000;fill-opacity:.44140" d="m2-0.86192h16v8h-16v-8z" inkscape:connector-curvature="0"/>
            </g>
          </g>
        </mask>
        <clipPath id="clipPath38">
          <path id="path40" d="m2-0.86192h16v8h-16v-8z" inkscape:connector-curvature="0"/>
        </clipPath>
        <clipPath id="clipPath42">
          <path id="path44" d="m2 0h16v8h-16v-8z" inkscape:connector-curvature="0"/>
        </clipPath>
        <linearGradient id="linearGradient50" y2="-31.002" gradientUnits="userSpaceOnUse" x2="-5.8529" gradientTransform="matrix(.6 -.00186 .00186 .6 17.891 22.75)" y1="-31.002" x1="-21.853">
          <stop id="stop52" style="stop-color:#ffffff" offset="0"/>
          <stop id="stop54" style="stop-color:#000000" offset="1"/>
        </linearGradient>
        <linearGradient id="linearGradient90" y2="10.2" gradientUnits="userSpaceOnUse" x2="46.15" gradientTransform="matrix(.6 0 0 -.6 .00064021 14.13)" y1="10.2" x1="1.1006">
          <stop id="stop92" style="stop-color:#9cadb5" offset="0"/>
          <stop id="stop94" style="stop-color:#e0e0e0" offset="1"/>
        </linearGradient>
        <radialGradient id="radialGradient110" gradientUnits="userSpaceOnUse" cy="-21.613" cx="2.2554" gradientTransform="matrix(-.06528 -.5964 .5568 -.07032 24.902 10.985)" r="21.012">
          <stop id="stop112" style="stop-color:#f2db8a" offset="0"/>
          <stop id="stop114" style="stop-color:#877531" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient128" gradientUnits="userSpaceOnUse" cy="-16.343" cx="1.939" gradientTransform="matrix(-.066 -.5964 .55576 -.07104 18.812 11.724)" r="2.9554">
          <stop id="stop130" style="stop-color:#d4c17d" offset="0"/>
          <stop id="stop132" style="stop-color:#b3a051" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient146" gradientUnits="userSpaceOnUse" cy="-16.098" cx="7.0215" gradientTransform="matrix(-.066 -.59632 .55768 -.07056 18.561 11.781)" r="3.295">
          <stop id="stop148" style="stop-color:#d4c17d" offset="0"/>
          <stop id="stop150" style="stop-color:#b3a051" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient164" gradientUnits="userSpaceOnUse" cy="-36.492" cx="4.6558" gradientTransform="matrix(-.06496 -.59648 .55512 -.07088 41.982 8.7709)" r="2.5399">
          <stop id="stop166" style="stop-color:#d4c17d" offset="0"/>
          <stop id="stop168" style="stop-color:#b3a051" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient182" gradientUnits="userSpaceOnUse" cy="-21.334" cx="4.3125" gradientTransform="matrix(-.06528 -.5964 .55656 -.07 24.575 11.039)" r="19.176">
          <stop id="stop184" style="stop-color:#d4c17d" offset="0"/>
          <stop id="stop186" style="stop-color:#b3a051" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient200" gradientUnits="userSpaceOnUse" cy="-22.418" cx="-0.499" gradientTransform="matrix(-.06544 -.5964 .55688 -.07 25.831 10.884)" r="19.718">
          <stop id="stop202" style="stop-color:#c7b577" offset="0"/>
          <stop id="stop204" style="stop-color:#bdaa57" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient218" gradientUnits="userSpaceOnUse" cy="-22.026" cx="-.85210" gradientTransform="matrix(-.06544 -.5964 .55688 -.07 25.38 10.94)" r="19.718">
          <stop id="stop220" style="stop-color:#e3d49d" offset="0"/>
          <stop id="stop222" style="stop-color:#e0ca70" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient236" gradientUnits="userSpaceOnUse" cy="-22.192" cx="-.7324" gradientTransform="matrix(-.06536 -.5964 .55688 -.07024 25.57 10.904)" r="24.445">
          <stop id="stop238" style="stop-color:#e6d189" offset="0"/>
          <stop id="stop240" style="stop-color:#bdaa57" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient254" gradientUnits="userSpaceOnUse" cy="-21.855" cx="-1.0425" gradientTransform="matrix(-.06536 -.5964 .55688 -.07024 25.183 10.952)" r="24.445">
          <stop id="stop256" style="stop-color:#fff6d4" offset="0"/>
          <stop id="stop258" style="stop-color:#e0ca70" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient272" gradientUnits="userSpaceOnUse" cy="-24.477" cx="4.4702" gradientTransform="matrix(-.06552 -.5964 .5568 -.07008 28.202 10.581)" r="17.982">
          <stop id="stop274" style="stop-color:#d6c894" offset="0"/>
          <stop id="stop276" style="stop-color:#a89642" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient290" gradientUnits="userSpaceOnUse" cy="-24.129" cx="4.061" gradientTransform="matrix(-.06552 -.5964 .5568 -.07008 27.802 10.632)" r="17.982">
          <stop id="stop292" style="stop-color:#fff6d4" offset="0"/>
          <stop id="stop294" style="stop-color:#e0ca70" offset="1"/>
        </radialGradient>
        <radialGradient id="radialGradient308" gradientUnits="userSpaceOnUse" cy="-26.365" cx="4.2339" gradientTransform="matrix(-.06552 -.5964 .5568 -.07008 30.378 10.308)" r="16.486">
    ...
    <metadata><rdf:RDF><cc:Work><dc:format>image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage"/><cc:license rdf:resource="http://creativecommons.org/licenses/publicdomain/"/><dc:publisher><cc:Agent rdf:about="http://openclipart.org/"><dc:title>Openclipart</dc:title></cc:Agent></dc:publisher></cc:Work><cc:License rdf:about="http://creativecommons.org/licenses/publicdomain/"><cc:permits rdf:resource="http://creativecommons.org/ns#Reproduction"/><cc:permits rdf:resource="http://creativecommons.org/ns#Distribution"/><cc:permits rdf:resource="http://creativecommons.org/ns#DerivativeWorks"/></cc:License></rdf:RDF></metadata></svg></xml>
    )   
}
